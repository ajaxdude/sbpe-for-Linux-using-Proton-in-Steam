...
- SBPE Windows release (download below)

## Installation Steps

### 1. Download Required Files

#### 1.1 Download StarBreak
1. Open Steam
2. Search for and download **StarBreak** (Windows version)
3. Let the game download completely

#### 1.2 Download SBPE Windows Release
**IMPORTANT**: Linux users must download the Windows release of SBPE to work with Proton in Steam.

Download the latest SBPE Windows release from the official repository:
- **Direct Download Link**: https://github.com/atomizer/sbpe/releases/download/v1.7.0/sbpe-windows-1.7.0.zip
- **Release Page**: https://github.com/atomizer/sbpe/releases
